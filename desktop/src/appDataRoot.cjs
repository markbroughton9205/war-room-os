/**
 * Electron main / Council bootstrap app-data resolver.
 * Algorithm is canonical and must stay identical to
 * lib/sovereign-runtime/local-ownership/appDataRoot.cjs
 * (asar cannot require repo lib/).
 *
