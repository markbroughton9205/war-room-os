...
| 22 | Ascension / Agent Development | NOT STARTED — constrained by `docs/architecture/ROADMAP_22_ASCENSION_INPUT_CONTRACT.md`; opening hardening gates A–C required before granting Ascension reach |
