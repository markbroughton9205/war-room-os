...
export async function runStage3AReviewValidation(): Promise<{ passed: number; failed: number; results: Check[] }> {
  ...
  results.push(check('11_status', STAGE3A_STATUS === 'REVIEWED' && STAGE3A_REVIEW_STATUS === 'COMPLETE' && (NEXT_AUTHORIZED_PASS === 'STAGE3A_REVIEW_COMPLETE' || NEXT_AUTHORIZED_PASS === 'STAGE3A_CANDIDATE_SELECTION_COMPLETE' || NEXT_AUTHORIZED_PASS === 'STAGE3A_CANDIDATE_ADJUDICATION_COMPLETE'), STAGE3A_STATUS))
