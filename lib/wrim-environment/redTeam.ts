...
const MESSAGES: Record<ForbiddenEnvAction, string> = {
  ...
  START_STAGE_3: 'WRIM1-RUN-000003 STAGE3A review is COMPLETE. Classification B. REVIEW_REQUIRED_CONTINUOUS_DRIFT. HEALTHY_FOR_CONTINUATION=false. TRAINING_AUTHORIZATION=OFF. Do not start STAGE3B. Do not train.',
