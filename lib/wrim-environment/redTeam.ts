...
const MESSAGES: Record<ForbiddenEnvAction, string> = {
  ...
  START_STAGE_3: 'WRIM1-RUN-000003 STAGE3A candidate adjudication is COMPLETE. No clear winner among WRIM-0 / STEP25_A0.2 / STEP25_A0.4 / STEP50_A0.5. Interpolants remain TEST_ONLY_MERGE and are not promoted. Raw step50 remains B. REVIEW_REQUIRED_CONTINUOUS_DRIFT. HEALTHY_FOR_CONTINUATION=false. TRAINING_AUTHORIZATION=OFF. Do not start STAGE3B. Do not train. Do not promote.',
