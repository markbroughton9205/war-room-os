...
const MESSAGES: Record<ForbiddenEnvAction, string> = {
  ...
  START_STAGE_3: 'WRIM1-RUN-000003 STAGE3A is COMPLETE_PENDING_REVIEW. STAGE3_AUTHORIZATION=NO_PENDING_REVIEW and TRAINING_AUTHORIZATION=OFF. Do not start STAGE3B. Do not train.',
