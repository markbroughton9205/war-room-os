...
export const TRAINING_AUTHORIZATION = 'PHASE2_GRID_ONLY' as const
...
export const PHASE2_STATUS = 'AUTHORIZED_RUNNING' as const
export const CONTROLLED_STABILITY_CLASSIFICATION = 'TEST_ONLY / CONTROLLED_EXPERIMENT / PHASE2_GRID' as const
export const NEXT_AUTHORIZED_PASS = 'PHASE2_PRIMARY_GRID' as const
