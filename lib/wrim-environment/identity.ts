 ...
 * STAGE3A Commander review complete. Candidate selection complete. Candidate adjudication complete. Training OFF. STAGE3B not authorized. No Ra'el. No promotion.
 */
...
export const STAGE3A_CANDIDATE_ADJUDICATION_STATUS = 'COMPLETE' as const
export const PREFERRED_STAGE3A_EVALUATION_CANDIDATE = 'NO_CLEAR_WINNER' as const
export const STAGE3A_PREFERRED_KIND = 'UNRESOLVED_PARETO' as const
