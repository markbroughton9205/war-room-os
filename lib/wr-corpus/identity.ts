...
export const WRIM_ENVIRONMENT = 'READY' as const
export const WRIM_PYTORCH_PORT = 'STAGE0_VERIFIED' as const
export const WRIM_STAGE1 = 'STAGE1_VERIFIED' as const
export const WRIM_STAGE2 = 'STAGE2_STOPPED_BY_SENTINEL' as const
export const WRIM_STAGE2_CLASSIFICATION = 'TEST_ONLY / STOPPED_BY_SENTINEL / REJECTED_FOR_STAGE3' as const
...
export function wrCorpusTruthNotes(): string[] {
  return [
    ...
    'HISTORICAL_WRIM_1 = REJECTED_COLLAPSED',
    'WRIM_RECONCILIATION = COMPLETE',
    'WRIM_CONTINUATION = B_REBUILD_WRIM_1_FROM_WRIM_0',
    'WRIM_REBUILD_DESIGN = COMPLETE',
    'WRIM_REBUILD_DESIGN_DECISION = READY_FOR_NEBULA_ENVIRONMENT_SETUP',
    'WRIM_ENVIRONMENT = READY',
    'WRIM_PYTORCH_PORT = STAGE0_VERIFIED',
    'WRIM_STAGE1 = STAGE1_VERIFIED',
    'WRIM_STAGE2 = STAGE2_STOPPED_BY_SENTINEL',
    'WRIM_STAGE2_CLASSIFICATION = TEST_ONLY / STOPPED_BY_SENTINEL / REJECTED_FOR_STAGE3',
