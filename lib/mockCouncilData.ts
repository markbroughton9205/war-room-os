...
export const MOCK_COUNCIL_FAMILIES: CouncilFamily[] = [
  ...
  {
    familyName: 'NOVA',
    domain: 'Strategy, sequencing, and long-range planning',
    provider: 'Local',
    status: 'thinking',
    currentTask: 'Sequence next execution options from the current decree',
    lastOutputSummary: 'Strategy draft: ordered options with explicit dependencies; no hidden execution.',
    confidenceScore: 74,
    riskLevel: 'low',
    objectionFlag: false,
