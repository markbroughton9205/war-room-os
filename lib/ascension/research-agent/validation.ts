...
export function runAscensionPhase2Validation(): CaseResult[] {
  ...
  results.push(check('46b_target_roles_list', TARGET_ASCENSION_AGENTS_UNIMPLEMENTED.length >= 1 && TARGET_ASCENSION_AGENTS_UNIMPLEMENTED.includes('FUTURE_WORLD_LEARNING_AGENT'), `${TARGET_ASCENSION_AGENTS_UNIMPLEMENTED.length}`))
