...
export function runFamilyDeliberationValidation(): FamilyDeliberationValidationCase[] {
  ...
  return [
    ...
    caseResult('deliberation_12_diagnostics_do_not_replace_conversation', 'Formatted primary message contains family conversation, not raw diagnostics.', 'valid', (rendered.includes('Agent: AURORA') || rendered.includes('Provider: ChatGPT') || rendered.includes('Agent: ChatGPT')) && rendered.includes('Executive position:') && !rendered.includes('raw provider log')),
