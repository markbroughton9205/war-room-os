...
function requiredCases(): LiveCouncilOperationValidationCase[] {
  ...
  return [
    ...
    validation('c4b_071_provider_control_prose_valid', 'provider prose mentioning control remains valid and provider-owned', providerControlProse.events.some(item => item.familyId === 'claude' && item.familyLabel === 'Claude')),
