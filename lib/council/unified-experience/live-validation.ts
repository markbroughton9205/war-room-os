...
function requiredCases(): LiveCouncilOperationValidationCase[] {
  ...
  return [
    ...
    validation('c4b_080_duplicate_completion_one_copy_statement', 'duplicate completion produces one copy statement', (duplicateCompletionCopy.match(/Council Round Completed/g) ?? []).length === 1, [duplicateCompletionCopy]),
