...
export const BABY_AI_AGENTS: BabyAgent[] = [
  ...
  },
  {
    ...
    cloudProvider: 'Cloud provider council',
    role: 'Revenue leverage ranking, repeatable service-model detection, payout risk notes, and low-ROI distraction warnings.',
    memoryScope: ['opportunity results', 'economic workflows', 'revenue outcomes', 'profitable patterns', 'payment guard findings'],
    growthLevel: 'seed',
    confidenceScore: 0.33,
    usefulnessScore: 0.32,
    nextTrainingNeed: 'Observe which revenue opportunities converted, wasted time, repeated profitably, or increased family stress.',
    latestLesson: 'Prioritize fast-to-revenue, repeatable, low-friction opportunities without claiming income before proof.',
    skillTree: [
      skill('income_workflow_review', 'Income workflow review', 'Summarize income workflow status truthfully.', 0.32),
      skill('leverage_scoring', 'Leverage scoring', 'Rank opportunities by income per unit of attention.', 0.31),
      skill('repeatable_service_models', 'Repeatable service models', 'Spot profitable workflows that can be packaged and repeated.', 0.3),
    ],
  },
]
