...
const INTENT_PROVIDER_MAP: Record<ResearchQueryIntent, ResearchProviderId[]> = {
  ...
  maritime_traffic: ['digitraffic_marine', 'barentswatch_ais', 'aisstream', 'aishub_marine', 'ais_catcher_own_sensor'],
  ...
  entity_knowledge_graph: ['wikidata', 'library_of_congress', 'github', 'sam_gov', 'gleif', 'orcid', 'wikimedia_commons', 'dbpedia', 'isni', 'lobid_gnd', 'factgrid', 'conceptnet', 'musicbrainz', 'google_kg_search', 'merriam_webster', 'yago', 'data_commons'],
