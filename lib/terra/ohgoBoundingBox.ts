/**
 * Terra OHGO / ODOT camera layer → bounding-box query. Adapter sends official
 * map-bounds-sw / map-bounds-ne (never statewide page-all). Query text is
 * lamin,lomin,lamax,lomax, same shape as Ontario / Digitraffic.
 */
