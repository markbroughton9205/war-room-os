...
export const ROAD_TRAFFIC_SOURCE_REGISTRY: RoadTrafficSourceRecord[] = [
  ...
  },
  {
    ...
    jurisdiction: 'Ohio, USA (not Ohio Turnpike)',
    capabilities: ['camera'],
  ...
  {
    id: 'ny511_cameras',
    displayName: 'New York State traffic cameras',
    ...
    configurationState: 'CREDENTIAL_REQUIRED',
    authenticationRequired: true,
    rightsState: '511NY developer terms. DAA: attribution "powered by 511NY"; product name is never "511NY"; no implied NYSDOT endorsement. Register via the 511NY developer/API key process on 511ny.org. Env: 511NY_API_KEY (server-side).',
    evidenceStatus: 'verified_via_official_docs_this_build',
    evidenceNote: 'IMPLEMENTED this phase. GET https://511ny.org/api/getcameras?key={511NY_API_KEY}&format=json. Stills via Url; VideoUrl is viewerUrl/link-out only — never scraped or auto-embedded. Disabled/Blocked → OFFLINE. Throttle 10 requests / 60s.',
  },
  {
    id: 'caltrans_cwwp2_cameras',
    displayName: 'Caltrans CWWP2 traffic cameras (California)',
    jurisdiction: 'California, USA',
    capabilities: ['camera'],
    researchProviderId: 'caltrans_cwwp2_cameras',
    reconciliationStatus: 'MISSING',
    configurationState: 'ENABLED',
    authenticationRequired: false,
    rightsState: 'Caltrans CWWP2 public CCTV status/image files. Stream fair-use: ≥10 concurrent streams need a written Caltrans agreement — this adapter never opens a stream. Docs: https://cwwp2.dot.ca.gov/documentation/cctv/cctv.htm.',
    evidenceStatus: 'verified_via_official_docs_this_build',
    evidenceNote: 'IMPLEMENTED this phase. Per-district PUBLIC_NO_AUTH JSON (d1–d12), e.g. /data/d8/cctv/cctvStatusD08.json. imageUrl=currentImageURL; inService false → OFFLINE; currentImageUpdateFrequency stored for the LIVE window (Last-Modified on inspect). streamingVideoURL is link-out only.',
  },
  {
    id: 'pennsylvania_511_hold',
    displayName: 'Pennsylvania 511 cameras (HOLD)',
    jurisdiction: 'Pennsylvania, USA',
    capabilities: ['camera'],
    researchProviderId: null,
    reconciliationStatus: 'REQUIRES_LICENSE_REVIEW',
    configurationState: 'TERMS_DEPENDENT',
    authenticationRequired: true,
    rightsState: 'HOLD — license review required before any adapter. Not implemented this build.',
    evidenceStatus: 'research_corpus_unverified',
    evidenceNote: 'Commander HOLD: PA (license). Do not implement until license review is complete.',
  },
  {
    id: 'michigan_511_hold',
    displayName: 'Michigan 511 cameras (HOLD — HTML viewer only)',
    ...
    configurationState: 'TERMS_DEPENDENT',
    authenticationRequired: false,
    rightsState: 'HOLD — HTML_VIEWER_ONLY. No lawful still-image adapter this build.',
    evidenceStatus: 'research_corpus_unverified',
    evidenceNote: 'Commander HOLD: MI is HTML_VIEWER_ONLY. Do not scrape or fabricate a JPEG URL.',
  },
  {
    id: 'ohio_turnpike_hold',
    displayName: 'Ohio Turnpike cameras (HOLD — HTML viewer only)',
    jurisdiction: 'Ohio Turnpike, USA',
    capabilities: ['camera'],
    researchProviderId: null,
    reconciliationStatus: 'NOT_SUITABLE',
    configurationState: 'TERMS_DEPENDENT',
    authenticationRequired: false,
    rightsState: 'HOLD — HTML_VIEWER_ONLY. Distinct from OHGO / ODOT cameras.',
    evidenceStatus: 'research_corpus_unverified',
    evidenceNote: 'Commander HOLD: Ohio Turnpike HTML viewers are not the OHGO adapter. Do not scrape or auto-embed.',
  },
  {
    id: 'tfnsw_cameras_hold',
    displayName: 'Transport for NSW cameras (HOLD)',
    ...
    configurationState: 'CREDENTIAL_REQUIRED',
    authenticationRequired: true,
    rightsState: 'HOLD — needs a Commander-issued TfNSW key before any adapter.',
    evidenceStatus: 'research_corpus_unverified',
    evidenceNote: 'Commander HOLD: TfNSW needs a key. Do not implement this build.',
  },
  {
    id: 'drivebc_cameras_hold',
    displayName: 'DriveBC camera images (HOLD — TLS UNVERIFIED)',
    jurisdiction: 'British Columbia, Canada',
    capabilities: ['camera'],
    researchProviderId: null,
    reconciliationStatus: 'NOT_SUITABLE',
    configurationState: 'TERMS_DEPENDENT',
    authenticationRequired: false,
    rightsState: 'HOLD — DriveBC image TLS UNVERIFIED. DriveBC events remain a separate implemented adapter.',
    evidenceStatus: 'research_corpus_unverified',
    evidenceNote: 'Commander HOLD: DriveBC camera images are TLS UNVERIFIED. Do not implement an image adapter this build. drivebc_events is unchanged.',
  },
]
