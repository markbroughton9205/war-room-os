import { BABY_AI_REPAIR_SQL, SIGNAL_REPAIR_SQL } from './repairSql'
import type { ExpectedMigration, ExpectedTable, SchemaFeatureId } from './types'
...
export const EXPECTED_TABLES: ExpectedTable[] = [
  ...
  table({ name: 'war_room_signal_sources', feature: 'signals', label: 'Signal sources', migrationFile: 'supabase/war_room_phase14_signals.sql', columns: ['id', 'label', 'provider', 'kind', 'categories', 'configured', 'reliability_score', 'notes', 'created_at', 'updated_at'], indexes: ['war_room_signal_sources_provider_idx'], exactRepairSql: SIGNAL_REPAIR_SQL }),
  ...
  table({ name: 'war_room_signal_results', feature: 'signals', label: 'Signal results', migrationFile: 'supabase/war_room_phase14_signals.sql', columns: ['id', 'scan_id', 'title', 'source', 'provider', 'source_kind', 'url', 'summary', 'category', 'highest_leverage_score', 'approval_status', 'captured_at', 'metadata', 'created_at', 'updated_at'], indexes: ['war_room_signal_results_leverage_idx'], exactRepairSql: SIGNAL_REPAIR_SQL }),
...
export const SCHEMA_VALIDATION_CHECKLIST = [
  ...
  'Verify connected surfaces: Runtime Integrity, Baby AI, Memory, Signal Radar, and Engineering Lane.',
]
