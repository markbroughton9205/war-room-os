...
import { generateSettlementNotification } from './corroborationNotifications'
import type { FieldVerification, SettlementAggregator, VerificationField } from './corroborationTypes'
...
export async function runSettlementCorroboration(
