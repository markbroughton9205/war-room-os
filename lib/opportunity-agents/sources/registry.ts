...
export const SOURCE_CONNECTIONS: SourceConnectionDescriptor[] = [
  ...
  { id: 'adzuna', displayName: 'Adzuna', category: 'opportunity', accessMethod: 'official Jobs API', costClass: 'free', requiredEnv: ['ADZUNA_APP_ID', 'ADZUNA_APP_KEY'], accountRequired: true, commanderApprovalRequired: false, notes: 'Official job discovery API; credentials remain server-side.' },
  { id: 'remote_ok', displayName: 'Remote OK', category: 'opportunity', accessMethod: 'official public API', costClass: 'free', requiredEnv: [], accountRequired: false, commanderApprovalRequired: false, notes: 'Remote job discovery with Remote OK attribution preserved.' },
