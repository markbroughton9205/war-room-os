...
export const PROVIDER_CONFIG_REGISTRY: ProviderConfigDefinition[] = [
  ...
  },
  {
    ...
    lastCheckResult: 'RSS registry and NewsAPI key presence only; live news fetch runs server-side in the Live Environment route.',
    missingDependency: 'RSS/news adapter or feed list',
    recommendedNextAction: 'Set NEWS_API_KEY for headline cards or NEWS_RSS_FEEDS with bounded source registry entries.',
  },
  {
    id: 'weather_provider',
