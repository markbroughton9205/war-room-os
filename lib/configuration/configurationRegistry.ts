...
export const PROVIDER_CONFIG_REGISTRY: ProviderConfigDefinition[] = [
  ...
  },
  {
    ...
    category: 'research_intel',
    requiredEnvVars: [],
    alternativeEnvVarGroups: [['NEWS_RSS_FEEDS'], ['NEWS_API_KEY']],
    required: 'recommended',
    ...
    lastCheckResult: 'Credential-free RSS registry presence only; live feed fetch runs server-side in the Live Environment route.',
    missingDependency: 'RSS/news adapter or feed list',
    recommendedNextAction: 'Set NEWS_RSS_FEEDS with bounded source registry entries. NEWS_API_KEY aliases are detected for provider readiness only.',
  },
  {
    id: 'weather_provider',
    ...
    category: 'research_intel',
    requiredEnvVars: [],
    optionalEnvVars: ['WEATHER_PROVIDER', 'WEATHER_LATITUDE', 'WEATHER_LONGITUDE'],
    alternativeEnvVarGroups: [['WEATHER_API_KEY'], ['WEATHER_LATITUDE', 'WEATHER_LONGITUDE']],
    required: 'recommended',
    ...
    recommendedNextAction: 'Set WEATHER_PROVIDER plus WEATHER_API_KEY for OpenWeather/WeatherAPI, or NOAA coordinates for NWS fallback.',
  },
  {
  ...
  },
  {
    ...
    optionalEnvVars: ['FINANCE_PROVIDER', 'FINANCE_SYMBOLS'],
    required: 'optional',
    ...
    recommendedNextAction: 'Set FINANCE_PROVIDER and FINANCE_API_KEY; optionally set FINANCE_SYMBOLS for the watchlist.',
  },
  {
