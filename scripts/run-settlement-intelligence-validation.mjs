...
const discoveryFixture=`<h2>Class Action Settlements: Millions Left on the Table Every Year</h2><h3>What happens to money after a settlement deadline?</h3><div id="fanatics-handling-fees" class="settlement-card"><h3><a href="https://handlingfeesettlement.test/" class="js-settlement-link" data-slug="fanatics-handling-fees" data-name="Fanatics - Handling Fees">Fanatics - Handling Fees Class Action Settlement</a></h3><img src="/media/fanatics-thumb.jpg"><p>Deadline 8/27/26 Proof Required? No</p><a href="https://handlingfeesettlement.test/" class="js-settlement-link" data-slug="fanatics-handling-fees" data-name="Fanatics - Handling Fees">Visit Official Settlement Website</a></div><div id="expired" class="settlement-card"><a href="https://expiredsettlement.test/" class="js-settlement-link" data-slug="expired" data-name="Expired Company">Expired Company Class Action Settlement</a><p>Deadline 8/21/26 Proof Required? No</p></div>`
