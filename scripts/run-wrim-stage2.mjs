...
const ckptDir = path.join(paths.data, 'wrim-checkpoints', 'test-only', 'WRIM1-NEBULA-STAB-000001')
const script = path.join(repoRoot, 'scripts', 'wrim-environment', 'stage2.py')
const result = spawnSync(
  ...
  [
    ...
    dump,
    '--report',
    path.join(paths.root, 'stage2-report.json'),
    '--ckpt-dir',
    ckptDir,
  ],
