...
export const TERRA_TRAFFIC_LAYER_DEFS: TerraTrafficLayerDef[] = [
  ...
  },
  {
    ...
    cluster: true,
    minScaleLevel: 'city',
    recencyNote: 'LIVE TRAFFIC VOLUMES — latest published hourly counts (typically ~2 hours behind wall clock). Not live signal phase.',
