...
// Node02 Council Command UI integration: lib/terra/terraLinkedStatus.ts is the real,
// evidence-backed producer that lib/terra/godsEyeStatusAdapter.ts was built to receive. NEUTRAL
...
function ActiveTerraContextPill() {
  ...
  return (
    <div className="flex min-w-0 items-center gap-2 border-b border-white/10 bg-slate-950/90 px-3 py-1.5 text-[9px] backdrop-blur-xl">
      ...
      <CouncilGodsEyeStatus status={godsEyeStatus} />
      {kindLabel ? (
